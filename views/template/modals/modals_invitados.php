    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="needs-validation" id="fntInvitado" method="post" role="form" novalidate="">
            ...
            <div class="form-group">
                <textarea name="descripcion_invitado" cols="40" rows="2" maxlength="250" class="form-control" style="margin-top: 0px; margin-bottom: 0px; height: 100px;" placeholder="ingrese la descripcion" id="descripcion_invitado"></textarea>
            </div>
